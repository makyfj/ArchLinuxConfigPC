...
var ProcessService = class {
  ...
  getDefaultOptions(options) {
    const defaultOptions = __assign({}, options);
    ...
    if (!defaultOptions.env || Object.keys(defaultOptions.env).length === 0) {
      defaultOptions.env = __assign({}, process.env);
    } else {
      defaultOptions.env = __assign({}, defaultOptions.env);
    }
